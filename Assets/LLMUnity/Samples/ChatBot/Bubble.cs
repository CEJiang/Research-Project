...
namespace LLMUnitySamples
{
    ...
    class Bubble
    {
        ...
        protected GameObject CreateTextObject(Transform parent, string name, string message, bool horizontalStretch = true, bool verticalStretch = false)
        {
            ...
            GameObject textObject = new(name, typeof(RectTransform), typeof(Text), typeof(Canvas));
        ...
        {
            GameObject imageObject = new(name, typeof(RectTransform), typeof(Image), typeof(Canvas));
        ...
        void SetBubblePosition(RectTransform bubbleRectTransform, RectTransform imageRectTransform, BubbleUI bubbleUI)
        {
            ...
            Vector2 anchoredPosition = new(bubbleUI.bubbleOffset + bubbleUI.textPadding, bubbleUI.bubbleOffset + bubbleUI.textPadding);
    ...
    class InputBubble : Bubble
    {
        ...
        {
            GameObject inputFieldObject = new("InputField", typeof(RectTransform), typeof(InputField), typeof(Canvas));
