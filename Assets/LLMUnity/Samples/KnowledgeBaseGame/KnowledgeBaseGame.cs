...
namespace LLMUnitySamples
{
    public class KnowledgeBaseGame : KnowledgeBaseGameUI
    {
        ...
        Dictionary<string, Dictionary<string, string>> botQuestionAnswers = new();
        Dictionary<string, RawImage> botImages = new();
        ...
        {
            Dictionary<string, string> questionAnswers = new();
        ...
        public async Task<List<string>> Retrieval(string question)
        {
            ...
            List<string> similarAnswers = new();
