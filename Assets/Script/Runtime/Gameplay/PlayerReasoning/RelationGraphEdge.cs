...
public class RelationGraphEdge : MonoBehaviour
{
    [SerializeField] private UILineRenderer lineRenderer;

    public RelationNode fromNode;
    public RelationNode toNode;
    public RelationGraphType relationType;
    ...
    public void Setup(RelationNode from, RelationNode to, RelationGraphType type)
    {
        fromNode = from;
        toNode = to;
        relationType = type;

        if (relationType == RelationGraphType.LEADTO && arrowHeadPrefab != null)
        {
    ...
    private void UpdateArrowHead(Vector2 start, Vector2 end)
    {
        ...
        if (relationType != RelationGraphType.LEADTO)
        {
