...
public class ReasoningGraphNode : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IPointerClickHandler
{
    [Header("UI")]
    ...
    {
        if (ReasoningGraphManager.Instance.currentReasoningGraphType != ReasoningGraphType.NONE) return;
    ...
    {
        ReasoningGraphManager.Instance.OnReasoningGraphNodeClicked(this);
    }
}