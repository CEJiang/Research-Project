...
public class PlayerInput : PlayerControls.IPlayerActions
{
    ...
    public InputButton MoveUp = new();
    public InputButton MoveDown = new();
    public InputButton MoveLeft = new();
    public InputButton MoveRight = new();
    public InputButton Move = new();
